...
#ifdef CONFIG_MYCAMERAAPPS_MYFIRSTCAMERAAPP_OUTPUT_LCD
...
int sdk_camera_example_main(int argc, FAR char *argv[])
{
  int ret;
  int v_fd;
...
#ifndef CONFIG_MYCAMERAAPPS_MYFIRSTCAMERAAPP_OUTPUT_LCD
...
//                      }
              ...
              if (app_state == APP_STATE_AFTER_CAPTURE)
              {
                app_state = APP_STATE_UNDER_CAPTURE;
              }
